...
CREATE TABLE `booking` (
  ...
  CONSTRAINT `FKjn3lsroa8t8h7x5sld9b0ru2u` FOREIGN KEY (`guest_id`) REFERENCES `guest` (`guest_id`)
...
INSERT INTO `booking` VALUES (1,1,1),(2,4,2),(3,5,3),(4,4,4),(5,4,5),(6,4,6),(7,4,7),(8,4,8),(9,5,9);
